...
Run python3 scripts/validate_foundation.py and mvn -B -f apps/backend/pom.xml verify before commits. Add behavior and adversarial tests as security or business features appear. Never weaken a test to report success. A mocked integration is not a live integration. Record exact failures and limitations.
