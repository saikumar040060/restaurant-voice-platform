(() => {
  ...
  const review = async () => {
    const [data, saved, summary] = await Promise.all([request("/api/v1/restaurant/menu-review-draft"), request("/api/v1/restaurant/menu-review-draft/decisions"), request("/api/v1/restaurant/menu-review-draft/summary")]);
